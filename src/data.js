...
export const place = [...targetsPeople.map(p => `${p} rally`), ...targetsOrgs];
...
export const interactiveKicker = [
  'Poll',
  'Quiz',
  'Guess',
  '#interactive',
...
export const opinion = [...positiveOpinion, ...negativeOpinion];
